...
```
User pastes inquiry into /studio/reception
        │
        ▼
...
| **lib/sessions/store.ts** | Remembers each room's current state (e.g. "Editing room last scanned: studio/projects/220-hudson/raw"). |
