...
export const SEO_SERVICE_PAGES: SeoServicePageConfig[] = [
  {
    ...
    intro:
      "Professional architecture and interior photography for commercial spaces, office renovations, and design-driven projects. BRIGHTLINE Photography captures scale, daylight, and composition so your assets feel premium across web, print, and leasing materials.",
    clientTypes: [
      "Architects",
      "Developers",
      "Interior designers",
  ...
  },
  {
    ...
    intro:
      "Commercial photography for brands, agencies, and properties—advertising, editorial, and architectural work with structured delivery and assets prepared for web, search, and social.",
    clientTypes: [
      "Brands and agencies",
      "Creative directors",
      "Marketing teams",
  ...
  },
  {
    ...
    title: "Corporate Photographer NYC | BRIGHTLINE Photography",
  ...
  },
  {
    ...
    title: "Real Estate Photographer Jersey City | BRIGHTLINE Photography",
