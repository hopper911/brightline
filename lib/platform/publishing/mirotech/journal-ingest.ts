/**
 * Mirotech journal ingest — Brightline blog → Mirotech JournalPost (Phase 6D domain layer).
 * Owns Brightline→Mirotech article transformation and ingest HTTP contract.
 */
