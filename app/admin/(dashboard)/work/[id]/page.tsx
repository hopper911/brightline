        ...
        <div className="rounded-xl border border-black/10 bg-white p-6">
          ...
          {editorialExpanded && (
            <div className="mt-4 space-y-4">
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs uppercase tracking-wide text-black/60">Context</label>
                <textarea
                  value={context}
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs uppercase tracking-wide text-black/60">
                  Approach (short paragraph or bullets)
                </label>
                <textarea
                  value={approach}
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs uppercase tracking-wide text-black/60">Closing (one line)</label>
                <textarea
                  value={closing}
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs uppercase tracking-wide text-black/60">Credits (optional)</label>
                <textarea
                  value={credits}
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs uppercase tracking-wide text-black/60">Project tags</label>
                <input
                  value={tagsRaw}
