...
export const metadata: Metadata = {
  title: "Terms of Service · BRIGHTLINE Photography",
  description: "Terms of service for BRIGHTLINE Photography. Usage terms for our website and services.",
    ...
    <div className="section-pad mx-auto max-w-3xl px-6 lg:px-10">
      ...
      <div className="prose prose-invert mt-8 space-y-6 text-sm text-white/80">
        ...
        <section>
          ...
          <p>
            BRIGHTLINE Photography provides commercial photography services.
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:info@brightlinephotography.com" className="text-white underline hover:no-underline">
